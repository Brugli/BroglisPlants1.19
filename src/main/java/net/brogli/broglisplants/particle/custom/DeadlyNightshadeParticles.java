...
public class DeadlyNightshadeParticles extends RisingParticle {
    ...
    DeadlyNightshadeParticles(ClientLevel p_107717_, double p_107718_, double p_107719_, double p_107720_, double p_107721_, double p_107722_, double p_107723_, SpriteSet p_107724_) {
    ...
    public static class EmissiveProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_234094_, ClientLevel p_234095_, double p_234096_, double p_234097_, double p_234098_, double p_234099_, double p_234100_, double p_234101_) {
            DeadlyNightshadeParticles deadlyNightshadeParticles = new DeadlyNightshadeParticles(p_234095_, p_234096_, p_234097_, p_234098_, p_234099_, p_234100_, p_234101_, this.sprite);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_107750_, ClientLevel p_107751_, double p_107752_, double p_107753_, double p_107754_, double p_107755_, double p_107756_, double p_107757_) {
            DeadlyNightshadeParticles deadlyNightshadeParticles = new DeadlyNightshadeParticles(p_107751_, p_107752_, p_107753_, p_107754_, p_107755_, p_107756_, p_107757_, this.sprite);
            deadlyNightshadeParticles.setAlpha(1.0F);
            return deadlyNightshadeParticles;
        }
    }
